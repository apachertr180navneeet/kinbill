                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control" type="date" id="date" name="date" value="{{ $purchaseBook->date }}">
                            </div>
                            <!-- Invoice Field -->
                            <div class="col-md-6 mb-3">
                                <label for="invoice" class="form-label">Invoice</label>
                                <input type="text" class="form-control" id="invoice" name="invoice" value="{{ $purchaseBook->invoice_number }}">
                            </div>
                            <!-- Vendor Field -->
                            <div class="col-md-6 mb-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <input type="text" class="form-control" id="total_tax" value="{{ number_format($purchaseBook->total_tax, 2) }}" name="total_tax" min="0" readonly>
                            </div>
                            <div class="col-md-3 mb-3"></div>
                        </div>
                        <!-- Other Expenses -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <input type="text" class="form-control" id="round_off" name="round_off" value="{{ number_format($purchaseBook->round_off, 2) }}" step="any">
                            </div>
                        </div>
                        <!-- Grand Total -->
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <input type="text" class="form-control" id="grand_total" name="grand_total" value="{{ number_format($purchaseBook->grand_total, 2) }}" min="0" readonly>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        let itemCount = {{ count($purchaseBook->purchesbookitem) }};
