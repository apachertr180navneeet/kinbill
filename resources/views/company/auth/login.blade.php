@extends('company.layouts.login_layout')
@section('content')
            ...
            <div class="card-body">
                ...
                <div class="app-brand justify-content-center">
                    <a href="index.html" class="app-brand-link gap-2">
                        ...
                        <span class="app-brand-text demo text-body fw-bolder text-capitalize">{{ config('app.name') }} Company Login</span>
                    </a>
                </div>
                <!-- /Logo -->
                {{--  <h4 class="mb-2">{{ config('app.name') }} Company Login ! 👋</h4>  --}}
