...
use App\Models\{User, PurchesBook, PurchesBookItem, SalesBook, SalesBookItem, StockReport,Item};
...
class StockReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('company.stock_report.index');
    }
